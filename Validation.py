...
def preprocess_features(california_housing_dataframe):
    ...
    Args:
        california_housing_dataframe: A Pandas DataFram expected to contain data
...
def preprocess_targets(california_housing_dataframe):
    """Prepares target features (lables) from the California housing dataset.

    Args:
     california_housing_dataframe: A Pandas DataFram expected to contain data
       from the California housing dataset.
    Returns:
     A DataFrame that contains the labels.
    """
...
print("test_root_mean_squared_error: %f " % test_root_mean_squared_error)
